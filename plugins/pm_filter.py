    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                     InlineKeyboardButton('🔰OTT UPDATES🔰', url='https://t.me/mcnewmovies'),
                    ]
                    ]
