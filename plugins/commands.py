...
async def start(bot, cmd):
    ...
    if usr_cmdall1.startswith("/start subinps"):
        ...
        await cmd.reply_photo(
            ...
            caption=f"Hai {cmd.from_user.mention}  Brooh!🙋,I'm[☞ 𝙸𝙼𝙳𝙱 𝙰𝚄𝚃𝙾 𝙵𝙸𝙻𝚃𝙴𝚁](https://t.me/Imdbfilter_bot) or you can call me as Auto-Filter Bot You Can Use Me As A Auto-filter in Your Group ....\n\nIts Easy To Use Me; Just Add Me To Your Group As Admin, Thats All, i will Provide Movies There...🤓\n\n⚠️More Help Check Help Button Below\n\n©️MᴀɪɴᴛᴀɪɴᴇD Bʏ   <a href=tg://user?id=718307810>🇮🇳🏆 𝒇𝔬𝔯ｋｅ𝓡 Ｔｇ🇮🇳💥♨</a>",
